            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-md-12 col-sm-12 text-center text-light details">
                        ...
                        <button type="button" className="btn checkresume" onClick={() => window.open('https://drive.google.com/file/d/1hMyFQ5H7D7GnGL8SvQVB70kBb-5xCwsC/view?usp=drivesdk', '_blank')}>
                            Check Resume
                        </button>
